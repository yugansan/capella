...
public class CapellaReplaceRunnable implements IRunnableWithProgress {
  ...
  private final Set<CapellaSearchMatch> matches;
  private String replacement = null;
  private final boolean rerunQueryAfterReplacement;

  private final CapellaReplaceQuery replaceQuery;

  public CapellaReplaceRunnable(CapellaSearchQuery searchQuery, Set<CapellaSearchMatch> matches,
  ...
  public boolean askForReplacementText() {
    ...
    for (CapellaSearchMatch capellaSearchMatch : matches) {
      occurrencesCount += capellaSearchMatch.getMatchOccurrences().size();
    }
