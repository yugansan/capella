...
public class CapellaSearchSettings {
  ...
  public IStatus validate() {
    ...
    if (isRegExSearch) {
      try {
        CapellaSearchSettings.createPattern(textPattern, isCaseSensitive, isRegExSearch);
  ...
  public static Pattern createPattern(String textPattern, boolean isCaseSensitive, boolean isRegExSearch) {
    ...
    return PatternConstructor.createPattern(textPattern, isCaseSensitive, isRegExSearch);
  }

  public Pattern createPattern() {
    return createPattern(textPattern, isCaseSensitive, isRegExSearch);
  }
