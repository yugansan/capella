...
public class CapellaSearchResultPage extends AbstractTextSearchViewPage {
  ...
  public CapellaSearchResultPage() {
    // It means the capella search result page will only support the tree layout.
  ...
  protected void configureTreeViewer(TreeViewer viewer) {
    ...
    viewer.setContentProvider(new CapellaSearchResultContentProvider(this));
  ...
  protected void configureTableViewer(TableViewer viewer) {
    // Do nothing, as the table layout is not supported in Capella Search Result Page
  }
  ...
  public void internalRemoveSelected() {
    ...
    for (Iterator<?> iterator = selection.iterator(); iterator.hasNext();) {
      ...
      if (selectedElement instanceof CapellaSearchMatch) {
        ...
        selectedMatches.addAll(capellaSearchResult.getDisplayedMatches((IProject) selectedElement));
      } else {
