...
public class CapellaSearchResultLabelProvider extends LabelProvider implements IStyledLabelProvider {
  ...
  public CapellaSearchResultLabelProvider(CapellaSearchResultPage capellaSearchResultPage) {
    ...
    // TODO: is it possible to make it independent from Navigator classes? 
  ...
  public StyledString getStyledText(Object element) {
    ...
    if (element instanceof EObject) {
      ...
      // FIXME: Fix the CapellaReadOnlyHelper.
      // - It is not normal when isControlable is true and isLockedByOther true as well
      // - In connected mode why a NOT-LOCKED element has "isControllable=false"
      if (/* !isControllable || */ isLockedByOther) {
