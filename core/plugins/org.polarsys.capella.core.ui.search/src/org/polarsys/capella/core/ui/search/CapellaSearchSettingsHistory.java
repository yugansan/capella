...
public class CapellaSearchSettingsHistory {
  ...
  private static final String SECTION_SEARCH = "org.polarsys.capella.core.ui.search.page"; //$NON-NLS-1$
  private static final String SECTION_HISTORY_PREFIX = "history"; //$NON-NLS-1$
  private static final String SECTION_HISTORY_COUNT = "history.count"; //$NON-NLS-1$
  ...
  private static final String SECTION_SEARCH_FIELD_PREFIX = "field"; //$NON-NLS-1$
  private static final String SECTION_SEARCH_FIELD_COUNT = "field.count"; //$NON-NLS-1$

  private static final String SECTION_SEARCH_PROJECT_PREFIX = "project"; //$NON-NLS-1$
  private static final String SECTION_SEARCH_PROJECT_COUNT = "project.count"; //$NON-NLS-1$
